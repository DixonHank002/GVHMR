...
from tools.video.create_video_from_frames import create_video_from_frames
...
def parse_args_to_cfg():
    ...
    parser.add_argument("--frames", type=str, default="debug/data/frames", help="path to your frames directory")
    parser.add_argument("--output_root", type=str, default=None, help="by default to outputs/demo")
    parser.add_argument("-s", "--static_cam", action="store_true", help="If true, skip DPVO")
    parser.add_argument("--verbose", action="store_true", help="If true, draw intermediate results")
    args = parser.parse_args()

    # Input, transfer frames into videos
    frame_path = Path(args.frames)
    assert frame_path.exists(), f"Frames not found at {frame_path}"
    temp_path = Path.joinpath(frame_path, "tmp_" + frame_path.parts[-1] + ".mp4")
    create_video_from_frames(frame_path, temp_path)
